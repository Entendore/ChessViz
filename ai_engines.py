...
class HeuristicEvaluator:
    ...
    # Piece-square tables for pawns (from white's perspective)
    PT = [
        0,  0,  0,  0,  0,  0,  0,  0,
...
class MCTSEngine:
    ...
    def search(self, board, iters):
        ...
        if root.children:
            ...
            pol = {c.move.uci(): c.visits / tv if tv else 0
