...
import csv, re, ast, base64, os, threading, shutil
import chess
...
# ═══════════════════════════════════════════════════════════════════════════════
#  Export Presets — YouTube, Shorts, TikTok, Instagram, etc.
# ═══════════════════════════════════════════════════════════════════════════════

class ExportPreset:
    """Describes a target video format / resolution for export."""
...
EXPORT_PRESETS = {
    "Board Only (544×544)": ExportPreset(
        "Board Only", 544, 544, 30, 1.0, (26, 26, 46),
        "Square board-only, original size"),
    "YouTube 720p (1280×720)": ExportPreset(
        "YouTube 720p", 1280, 720, 30, 0.82, (18, 18, 32),
        "16:9 HD — standard YouTube videos"),
    "YouTube 1080p (1920×1080)": ExportPreset(
        "YouTube 1080p", 1920, 1080, 30, 0.78, (18, 18, 32),
        "16:9 Full HD — best for YouTube"),
    "YouTube 4K (3840×2160)": ExportPreset(
        "YouTube 4K", 3840, 2160, 30, 0.75, (18, 18, 32),
        "16:9 4K — highest YouTube quality"),
    "YouTube Shorts (1080×1920)": ExportPreset(
        "YouTube Shorts", 1080, 1920, 30, 0.50, (18, 18, 32),
        "9:16 vertical — YouTube Shorts"),
    "TikTok (1080×1920)": ExportPreset(
        "TikTok", 1080, 1920, 30, 0.50, (18, 18, 32),
        "9:16 vertical — TikTok"),
    "Instagram Reels (1080×1920)": ExportPreset(
        "Instagram Reels", 1080, 1920, 30, 0.50, (18, 18, 32),
        "9:16 vertical — Instagram Reels"),
    "Instagram Square (1080×1080)": ExportPreset(
        "Instagram Square", 1080, 1080, 30, 0.82, (18, 18, 32),
        "1:1 square — Instagram feed"),
    "Twitter/X (1280×720)": ExportPreset(
        "Twitter/X", 1280, 720, 30, 0.80, (18, 18, 32),
        "16:9 — optimized for X/Twitter"),
    "Custom": ExportPreset(
        "Custom", 544, 544, 30, 0.82, (26, 26, 46),
...
class ExportConfig:
    ...
    def effective_sq_size(self):
        if self.preset_name and self.preset_name != "Board Only (544×544)" and self.preset_name != "Custom":
