...
from PySide6.QtWidgets import (
    ...
    QSpinBox, QLineEdit, QProgressBar, QGroupBox
)
from PySide6.QtCore import Qt, QTimer
from PySide6.QtGui import QFont, QPixmap
from constants import log, ExportConfig, THEMES, parse_opening_image, DATA_DIR
...
class OpeningsMixin:
    ...
    def _build_openings_tab(self):
        ...
        scroll = QWidget()  # Using QWidget directly for simplicity inside mixin
