"""Chess board widget — python-chess integration, themes, animations.
Delegates all rendering to rendering.py (no duplicated draw logic).
"""
...
from config import (
    SQ_SIZE, ANIM_SPEED_DEFAULT, ANIM_FPS, THEMES, HAS_NUMBA, log
)
from rendering import render_frame, render_card, qimage_to_np, qimage_to_np_batch
...
class ChessBoardWidget(QWidget):
    ...
    def _get_anim_state(self):
        ...
        return {'from': self.anim_from, 'to': self.anim_to,
                ...
                'captured': self.anim_captured,          # BUG-FIX: was missing
                'progress': t_eased}
    ...
    def paintEvent(self, e):
        ...
        img = render_frame(                    # delegates to rendering.py
